...
blocked = [] 
fake = '⁨ꪶᴅᴇᴠɪʟꜱᴇʀꫂ' 
fakeimage = fs.readFileSync(`./media/devil.jpeg`)
numbernye = '0'
join = '\`\`\`𝙒𝙀𝙇𝘾𝙊𝙈𝙀 NEW MEMBER 𝙃𝙊𝙒 𝘼𝙍𝙀 𝙔𝙊𝙐😌\`\`\`\n\n - [ 𝐷𝐼𝑁𝐺𝐴𝑁 ] -'
leave = '\`\`\`Sayonaraa👋\`\`\`'  
promote = '*𝙃𝙀𝙔 𝘾𝙊𝙉𝙂𝙍𝘼𝙏𝙎 𝙔𝙊𝙐 𝙂𝙊𝙏 𝘼𝘿𝙈𝙄𝙉 𝙍𝙊𝙇𝙀🥳*'
demote = '*𝙉𝙄𝙉𝙆 𝘼𝘿𝙈𝙄𝙉 𝘼𝙆𝘼𝘼𝙉 𝙆𝘼𝙕𝙃𝙄𝙑 𝙀𝙇𝙇𝘼𝙃🤣*'
public = false
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Owner︎\n'
            + 'ORG:Owner DEVIL;\n'
            + 'TEL;type=CELL;type=VOICE;waid=919656459062:+919656459062\n'  
            + 'END:VCARD'
	...
	//		if (!mek.key.fromMe) return
      ...
      const wit = moment.tz('Asia/Jayapura').format('HH:mm:ss')
		...
		const arg = chats.slice(command.length + 2, chats.length)
			...
			mess = {
				wait: '⌛ 𝙉𝙄 𝙊𝙍𝙐 𝙑𝘼𝙏𝙏𝘼𝙈 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙀𝙏𝙏𝘼 𝙈𝘼𝙏𝙃𝙄 𝙒𝘼𝙄𝙏 𝘾𝙃𝙀𝙔...⌛',
				success: '✔️ 𝙀𝙇𝙇𝘼𝙈 𝙎𝙀𝙏 𝙋𝙊𝙇𝙄... ✔️',
				error: {
					stick: '❌ Gagal, terjadi kesalahan saat mengkonversi gambar ke sticker ❌',
					Iv: '❌ Link tidak valid ❌'
				},
				only: {
					group: '❌ 𝙀 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙂𝙍𝙊𝙐𝙋𝙄𝙇𝙇 𝙈𝘼𝙏𝙃𝙍𝙀 𝙋𝘼𝙏𝙏𝙐 𝘽𝙍𝙊! ❌',
      ...
      const totalchat = await eka.chats.all()
			...
			const ownerNumber = ['919656459062@s.whatsapp.net'] // replace this with your number
...
const ftroli = {
 key: {
  ...
  message: { 
   ...
   itemCount: 99, 
   status: 200, 
   thumbnail: fs.readFileSync('./media/devicon.jpeg'), 
   surface: 200,
   message: 'ʙᴏᴛ ʙʏ ⁨ꪶᴅᴇᴠɪʟꜱᴇʀꫂ',  //ganti nama bot lu
		...
		message: {
			"productMessage": {
				"product": {
					"productImage":{
						"mimetype": "image/jpeg",
						"jpegThumbnail": fs.readFileSync(`./media/devicon.jpeg`)
					},
					"title": fake,
  ...
  if (!public){
    if (!mek.key.fromMe) return
			...
			switch(command) {
                ...
                case 'menu':
      menu =`┏━━「 DEVIL」━━━
͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏┃ ${prefix}sticker 「Reply Gambar」
┃ ${prefix}rsticker 「Reply Gambar」
┃ ${prefix}stickergif 「Reply Video」
┃ ${prefix}stickerwa 「Query」
┃ ${prefix}stickerwm 「Nama|Author」
┃ ${prefix}toimg 「Reply Sticker」
┃ ${prefix}togif 「Reply Sticker Gif」
┃ ${prefix}tovideo 「Reply Sticker Video」
┃ ${prefix}colong 「Reply Sticker」
┃ ${prefix}addstik 「Optional」
┃ ${prefix}addimg 「Optional」
...
┃ ${prefix}kick 「@Tag」
┃ ${prefix}hidetag 「Teks」
┃ ${prefix}stctag 「Reply Sticker」
┃ ${prefix}imgtag 「Reply Gambar」
┃ ${prefix}kontag 「Teks」
┃ ${prefix}kontak 「628xxx Nama 」
...
eka.sendMessage(from, menu, text,{contextInfo: {forwardingScore : 508, isForwarded: true},quoted : ftroli})
			  ...
			  //********** SELF&PUBLIC **********//
			  case 'self':
			  if (!mek.key.fromMe) return reply('*ᴀʏɪɴᴜ ɴᴇᴇ ᴇᴛʜᴀ?*')
			    public = false
			    eka.sendMessage(from, `\`\`\`Status : SELF\`\`\` \n\ © ⁨ꪶᴅᴇᴠɪʟꜱᴇʀꫂ`, text,{quoted :ftroli})
			    break
			    
			  case 'public':
			    if (!mek.key.fromMe) return reply('*ᴀʏɪɴᴜ ɴᴇᴇ ᴇᴛʜᴀ?*')
			    public = true
			    eka.sendMessage(from, `\`\`\`Status : PUBLIC\`\`\` \n\ © ⁨ꪶᴅᴇᴠɪʟꜱᴇʀꫂ`, text,{quoted :ftroli})
			    break
		...
		break
            ...
            eka.sendMessage(from, `[  🎰 | SLOTS ]\n-----------------\n🍋 : 🍌 : 🍍\n${somtoy}<=====\n🍋 : 🍌 : 🍍\n[  🎰 | SLOTS ]\n\nKeterangan : Jika anda Mendapatkan 3Buah Sama Berarti Kamu Win\n\nContoh : 🍍 : 🍍 : 🍍<=====`, text, { quoted: ftroli })
            break
            case 'archive':
            ...
            case 'delthischat':
                ...
                case 'shutdown':
                if (!mek.key.fromMe) return reply('*Are You Owner?*')
	           await eka.sendMessage(from, `okey...\n_baby 🙃..._`, text,{contextInfo: {forwardingScore : 508, isForwarded: true},quoted : ftroli})
		       await sleep(3000)
                eka.close()
		break
		...
		for (let mem of groupMembers) {
	   	members_id.push(mem.jid)
			  ...
			  case 'setreply':
			    if (args.length < 1) return reply('*𝙏𝙀𝙓𝙏 𝙉𝙀𝙃𝙄 𝘽𝙃𝘼𝙄😌😹?*') 
                    eka.updatePresence(from, Presence.composing) 
					if (args.length < 1) return
					fake = body.slice(10)
				...
				case 'setthumb':
				if (!mek.key.fromMe) return reply('*Are You Owner?*')
                                if (!isQuotedImage) return reply('Reply imagenya') = body.slice(8)
				boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
				delb = await eka.downloadMediaMessage(boij)
				imagenye.push(`${svst}`)
				fs.writeFileSync(`./media/devicon.jpeg`, delb)
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    eka.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: freply})
				...
				case 'togif':
					...
					ddatae = await imageToBase64(JSON.stringify('./media/devicon.jpeg').replace(/\"/gi, ''))
...
//NAMA GUA CANTUMIN COK (EKA GANS) 
        ...
        case 'grup':
                ...
                case 'infoall':
					...
					mentions(`*From :* - [ 𝙎𝙀𝙇𝙁 𝘽𝙊𝙏-\n*Info :*  ${body.slice(9)}\n*Total Member :* ${groupMembers.length} \n\n┏━━━⟪ *INFORMATION* ⟫━━━┓`+teks+'╚═ *「 SELF BOT」* ', members_id, true)
					break
